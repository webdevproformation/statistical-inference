...
`key words:`Asymptotics,  The Central Limit Theorem, Sample Mean versus Theoretical Mean, Sample Variance, versus Theoretical Variance, Distributions, Statistical Inference.
...
First the case of [a fair die, p=.167 for each of the sides an unbiased coin flip experiment, p =.5 are  presented](https://www.coursera.org/learn/statistical-inference/lecture/K2IVE/07-02-asymptotics-and-the-clt).
