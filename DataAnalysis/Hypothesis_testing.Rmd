...
[Sourced from Brian Caffo](https://github.com/bcaffo/courses/raw/master/06_StatisticalInference/09_HT/index.pdf)

![https://xkcd.com/1132/](https://github.com/lindangulopez/statistical-inference/blob/master/DataAnalysis/1607430888081.png?raw=true)
...
`Here the result has a t of 11.79, so we reject the null hypothesis.` 
You can also see whether the range of values in the confidence interval are of practical significance as it is expressed in the units of the data that you're interested in.
